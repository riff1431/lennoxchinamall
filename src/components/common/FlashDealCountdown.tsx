...
export function FlashDealCountdown({
  ...
  return (
    <div className="flex items-center gap-2 text-xs font-black font-montserrat">
      {label && (
      ...
      <div className="flex items-center gap-1 font-mono text-white">
        <span className="bg-[#000B24] border border-white/20 px-2 py-0.5 rounded-md text-xs font-black shadow-xs">
        ...
        <span className="text-white font-bold">:</span>
        <span className="bg-white text-[#FF1028] px-2 py-0.5 rounded-md text-xs font-black shadow-xs animate-pulse">
