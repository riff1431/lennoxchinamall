...
const DEFAULT_SHIPPING_METHODS: ShippingMethodRecord[] = [
  {
    id: "sm-1",
    name: "YunExpress Priority Direct Line",
    carrier: "YunExpress",
    service_type: "Priority Air",
    base_cost_usdt: 8.5,
    per_kg_cost_usdt: 4.0,
    estimated_days_min: 5,
    estimated_days_max: 8,
    free_shipping_min_order: 75.0,
    allowed_zones: ["North America", "European Union", "United Kingdom", "Australia & NZ"],
    is_active: true,
  ...
  {
    id: "sm-2",
    name: "SF International Priority Express",
    carrier: "SF Express",
    service_type: "Express Courier",
    base_cost_usdt: 18.0,
    per_kg_cost_usdt: 7.5,
    estimated_days_min: 3,
    estimated_days_max: 5,
    free_shipping_min_order: 150.0,
    allowed_zones: ["Middle East", "Southeast Asia", "East Asia"],
    is_active: true,
    created_at: "2026-08-24T12:00:00Z",
    updated_at: "2026-08-24T12:00:00Z",
  },
  {
    id: "sm-3",
    name: "DHL Express Wholesale Airfreight",
    carrier: "DHL Express",
    service_type: "Express Courier",
    base_cost_usdt: 32.0,
    per_kg_cost_usdt: 12.0,
    estimated_days_min: 2,
    estimated_days_max: 4,
    free_shipping_min_order: 300.0,
    allowed_zones: ["Global Priority"],
    is_active: true,
    created_at: "2026-08-24T12:00:00Z",
    updated_at: "2026-08-24T12:00:00Z",
  },
