...
export const MOCK_CATEGORIES: (Category & { iconName: string; subcategories?: string[] })[] = [
  {
    ...
    slug: "drones-fpv",
    parent_id: null,
    description: "Factory-direct 4K GPS drones, brushless motors, FPV cinewhoop racers, and goggles",
    image_url: "https://images.unsplash.com/photo-1508614589041-895b88991e3e?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1527977966376-1c8408f9f108?w=400&auto=format&fit=crop&q=80",
    icon: "Camera",
    iconName: "Camera",
    bg_color: "#F3E8FF",
    position: 1,
    is_active: true,
    seo_title: "4K Drones & FPV Racing - Lennox ChinaMall",
    seo_description: "Wholesale 4K GPS drones and FPV racing equipment.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    subcategories: ["4K GPS Drones", "FPV Racers", "Goggles & Radios", "LiPo Batteries & Propellers"],
    product_count: 148
  },
  {
    id: "cat-3dprinters",
    name: "3D Printers & Laser CNC",
    slug: "3d-printers",
    parent_id: null,
    description: "High precision FDM 3D printers, SLA resin printers, laser engravers, and filaments",
    ...
    position: 2,
    is_active: true,
    seo_title: "3D Printers & Laser CNC - Lennox ChinaMall",
    seo_description: "Direct-from-factory 3D printers and precision laser engravers.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    subcategories: ["FDM 3D Printers", "Resin 3D Printers", "Laser Engravers", "PLA & PETG Filaments"],
    product_count: 112
  },
  {
    id: "cat-audio",
    name: "Pro Audio & Boomboxes",
    slug: "audio-electronics",
    parent_id: null,
    description: "Heavy bass Bluetooth boomboxes, studio monitor headphones, and wireless mic systems",
    image_url: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1545454675-3531b543be5d?w=400&auto=format&fit=crop&q=80",
    icon: "Headphones",
    iconName: "Headphones",
    bg_color: "#EEF2FF",
    position: 3,
    is_active: true,
    seo_title: "Pro Audio & Boomboxes - Lennox ChinaMall",
    seo_description: "High fidelity Bluetooth speakers and audio equipment.",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    subcategories: ["Bluetooth Boomboxes", "Studio Headphones", "Wireless Microphones", "Mixers & DACs"],
    product_count: 235
  },
  {
    id: "cat-mf",
    ...
    image_url: "https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&auto=format&fit=crop&q=80",
    icon: "Shirt",
    iconName: "Shirt",
    bg_color: "#EBF4FB",
    position: 4,
  ...
  },
  {
    ...
    thumbnail_url: "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=400&auto=format&fit=crop&q=80",
    icon: "ShoppingBag",
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1503944570678-75c1a7d6e42b?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=400&auto=format&fit=crop&q=80",
    icon: "Baby",
    iconName: "Baby",
    bg_color: "#FBEBF4",
    position: 6,
  ...
  },
  {
    ...
    thumbnail_url: "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&auto=format&fit=crop&q=80",
    icon: "Sparkles",
    iconName: "Sparkles",
    bg_color: "#EBFBF2",
    position: 7,
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1548767797-d8c844163c4c?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=400&auto=format&fit=crop&q=80",
    icon: "Footprints",
    iconName: "Footprints",
    bg_color: "#EBF9FB",
    position: 8,
  ...
  },
  {
    ...
    thumbnail_url: "https://images.unsplash.com/photo-1570222094114-d054a817e56b?w=400&auto=format&fit=crop&q=80",
    icon: "Utensils",
    iconName: "Utensils",
    bg_color: "#F4FBEB",
    position: 9,
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1522771930-78848d9293e8?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1522771930-78848d9293e8?w=400&auto=format&fit=crop&q=80",
    icon: "Baby",
    iconName: "Baby",
    bg_color: "#FBEBEB",
    position: 10,
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1517649763962-0c623266ddc0?w=400&auto=format&fit=crop&q=80",
    icon: "Dumbbell",
    iconName: "Dumbbell",
    bg_color: "#EBF4FB",
    position: 11,
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1468495244123-6c6c332eeede?w=1200&auto=format&fit=crop&q=80",
    thumbnail_url: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&auto=format&fit=crop&q=80",
    icon: "Smartphone",
    iconName: "Smartphone",
    bg_color: "#EEF2FF",
    position: 12,
  ...
  },
  {
    ...
    thumbnail_url: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?w=400&auto=format&fit=crop&q=80",
    icon: "Car",
    iconName: "Car",
    bg_color: "#E0F2FE",
    position: 14,
...
- **Waypoints & Orbit Mode**: Program flights directly on mobile app with live 5G FPV stream.`,
    ...
    weight: 0.85,
    net_weight: 0.23,
    dimensions: { length: 24, width: 19, height: 7, unit: "cm", volumetric_weight: 0.64, cbm: 0.0032 },
    shipping_origin: "Shenzhen, Guangdong, China",
    hs_code: "8806.22.00",
    cargo_type: "lithium_built_in",
    package_type: "corrugated_box",
    customs_declared_value: 28.00,
    customs_declaration_name: "Foldable 4K GPS RC Drone Toy / 遥控无人机",
    lead_time: "Same Day Dispatch (24h)",
    domestic_shipping_cost: 1.50,
    moq: 1,
...
export interface IntegrationService {
  id: string;
  name: string;
  category: "Payment Gateway" | "Database & Auth" | "Logistics & Tracking" | "Communications" | "Security" | "Cloud Media Storage";
  iconName: string;
  status: "healthy" | "degraded" | "configured" | "pending_keys";
  lastCheck: string;
  responseTimeMs: number;
  authMethod: "API Key + HMAC SHA512" | "Supabase Service Role" | "Bearer OAuth2" | "Webhook Secret" | "Cloudinary API Secret";
  endpoint: string;
  details: string;
}
...
export const MOCK_INTEGRATIONS: IntegrationService[] = [
  ...
  {
    id: "int-2",
    name: "Cloudinary Global Media CDN & Storage",
    category: "Cloud Media Storage",
    iconName: "Cloud",
    status: "healthy",
    lastCheck: "Just now",
    responseTimeMs: 24,
    authMethod: "Cloudinary API Secret",
    endpoint: "https://api.cloudinary.com/v1_1/vojfukje/image/upload",
    details: "Cloud environment 'vojfukje' connected. Automated WebP conversion, auto-tagging, and Fastly Global CDN media delivery.",
  },
  {
    id: "int-3",
