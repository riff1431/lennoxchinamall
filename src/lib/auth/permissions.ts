...
> = {
  super_admin: {
    ...
    "hero-section": ["view", "create", "update", "delete", "settings"],
  ...
  admin: {
    ...
    "hero-section": ["view", "create", "update", "delete"],
  ...
  product_manager: {
    ...
    "hero-section": ["view", "create", "update"],
